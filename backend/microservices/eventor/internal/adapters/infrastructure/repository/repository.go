...
import (
	...
	"github.com/Iamirup/whaler/backend/microservices/eventor/pkg/utils"
	"go.uber.org/zap"
)
...
func NewTableConfigRepository(logger *zap.Logger, cfg *Config, rdbms rdbms.RDBMS) ports.TableConfigPersistencePort {
	return &tableConfigRepository{logger: logger, config: cfg, rdbms: rdbms}
}
