...
import (
	...
	"github.com/Iamirup/whaler/backend/microservices/blog/pkg/utils"
	"go.uber.org/zap"
)
...
func NewArticleRepository(logger *zap.Logger, cfg *Config, rdbms rdbms.RDBMS) ports.ArticlePersistencePort {
	return &articleRepository{logger: logger, config: cfg, rdbms: rdbms}
}
