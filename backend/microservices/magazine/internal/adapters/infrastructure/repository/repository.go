...
import (
	...
	"github.com/Iamirup/whaler/backend/microservices/magazine/pkg/utils"
	"go.uber.org/zap"
)
...
func NewNewsRepository(logger *zap.Logger, cfg *Config, rdbms rdbms.RDBMS) ports.NewsPersistencePort {
	return &newsRepository{logger: logger, config: cfg, rdbms: rdbms}
}
