<template>
  ...
  <div class="pt-32 p-6 min-h-screen">
    <div v-for="article in articles" :key="article.article_id" @click="selectArticle(article)" class="p-4 bg-gradient-to-b from-cyan-800 to-slate-50 rounded-lg shadow-lg mb-4 cursor-pointer hover:bg-gray-50 transition break-words duration-150">
