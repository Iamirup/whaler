<template>
  <Nav />
  <div class="mt-32 p-6 bg-gray-100 min-h-screen">
    <div v-for="article in articles" :key="article.article_id" @click="selectArticle(article)" class="p-4 bg-white rounded-lg shadow-lg mb-4 cursor-pointer hover:bg-gray-50 transition break-words duration-150">
