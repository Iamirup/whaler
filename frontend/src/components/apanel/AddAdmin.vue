...
<template>
  <div class="bg-white shadow-lg rounded-lg p-6 mb-6">
    ...
    <div class="flex items-center mb-4">
      <input v-model="userId" placeholder="Enter Admin ID" class="w-full p-3 border border-gray-300 rounded-l-md focus:outline-none" />
...
export default defineComponent({
  ...
  methods: {
    async addAdmin() {
      await axios.post(`/api/auth/v1/admin`, { user_id: this.userId })
        .then(() => {
